...
sealed interface RepeatMode : java.io.Serializable {
    ...
    val name: String
    fun repeatedModelValid(startTime: Long, sourceStartTime: Long): Boolean
    fun repeatStartTimeByIndex(startTime: Long, index: Int): Long

    object Never : RepeatMode {
        override val repeatModeInt: Int = 0
        override val repeatInterval: Int = 0
        override val name: String = "永不"
        override fun repeatedModelValid(startTime: Long, sourceStartTime: Long): Boolean {
            return false
        }

        override fun repeatStartTimeByIndex(startTime: Long, index: Int): Long {
            return startTime
        }
    }
    ...
    object Day : RepeatMode {
        ...
        override fun repeatStartTimeByIndex(startTime: Long, index: Int): Long {
            return startTime + index * dayMillis
        }
    }
    ...
    object WorkDay : RepeatMode {
        ...
        override fun repeatedModelValid(startTime: Long, sourceStartTime: Long): Boolean {
            val weekday = startOfDay(startTime).get(Calendar.DAY_OF_WEEK)
    ...
    object Week : RepeatMode {
        ...
        override fun repeatStartTimeByIndex(startTime: Long, index: Int): Long {
            return startTime + index * 7 * dayMillis
        }
    }
    ...
    object Month : RepeatMode {
        ...
        override fun repeatedModelValid(startTime: Long, sourceStartTime: Long): Boolean {
            return startTime.dayOfMonth == sourceStartTime.dayOfMonth
        }

        override fun repeatStartTimeByIndex(startTime: Long, index: Int): Long {
            return startTime.calendar.apply {
    ...
    object Year : RepeatMode {
        ...
        override fun repeatedModelValid(startTime: Long, sourceStartTime: Long): Boolean {
            return startTime.dayOfMonth == sourceStartTime.dayOfMonth && startTime.dayOfYear == sourceStartTime.dayOfYear
        }
    ...
    data class Custom(
        ...
        override fun repeatStartTimeByIndex(startTime: Long, index: Int): Long {
            return startTime + index * repeatInterval * dayMillis
        }
    }
